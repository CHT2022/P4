...
#building flask table for showing predictions
class Results(Table):
    title = Col('Delay prediction at arrival')
...
def result():
	...
	def predict_delay(month,origin,destination,carrier,dep_delay):
		X1 = [{'ORIGIN':origin,
	...
	try:
		output = predict_delay(month,origin,dest,carrier,dep_delay)
